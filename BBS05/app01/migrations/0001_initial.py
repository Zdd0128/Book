# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2021-06-14 04:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=32, null=True, verbose_name='手机号码')),
                ('create_time', models.DateField(auto_now_add=True, verbose_name='注册时间')),
                ('avatar', models.FileField(default='static/image/def.jpg', upload_to='avatar/', verbose_name='头像')),
                ('save_pwd', models.BooleanField(verbose_name='记住密码')),
            ],
            options={
                'verbose_name': 'user',
